    ...
    <footer>
      <div className='w-full flex justify-between'>
        ...
        <div className='flex items-end'>
          <span className='flex text-center font-black-han text-[35px] leading-[134%] text-[#EA5514] py-4 px-2'>
            CASK <br></br>CARNIVAL
          </span>
          <img src='/png/cask_carnival_logo.png' alt='Cask Carnival Logo' className='w-[134px] py-6' />
        </div>
      </div>
      <div className='h-[51px] items-center py-4 px-2 flex justify-between bg-[#EA5514] text-white font-roboto text-[14px]'>
        {/* 하단 부분 */}
